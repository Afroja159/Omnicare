...
class _AllProductSectionState extends State<AllProductSection> {
  ...
  bool showAllProducts = false; // Variable to track whether to show all products// Variable to track whether to show all products
  ...
  void addToCart(int index) {
    ...
    if (existingItem.quantity > 0) {
      ...
      var item = CartItem(
        ...
        sell_price: double.parse('${allproductsList[index]['sell_price'].replaceAll(',', '')}'),
        after_discount_price: double.parse('${allproductsList[index]['after_discount_price'].replaceAll(',', '')}'),
        company_name: allproductsList[index]['brand']['brand_name'] ?? 'Unknown Company',
  ...
  Widget build(BuildContext context) {
    List<dynamic> displayedProducts =
        showAllProducts ? allproductsList : allproductsList.take(50).toList();
                                ...
                                Expanded(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      // Text(
                                      //   '${allproductsList[index]['brand']['brand_name'].split(' ').take(3).join(' ')}',
                                      //   style: fontStyle(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              if (allproductsList[index]['discount_type']?.toLowerCase() == 'percent')
                                                Text('% Off',
                                      ...
                                      // Text(
                                      //   '${allproductsList[index]['category']['category_name'] ?? 'Unknown Category'}',
                                      //   style: fontStyle(
                                      //       6.sp, Colors.black, FontWeight.w400),
                                      // ),
                                      // Display either the "ADD" button or quantity control buttons
                                      productQuantities[allproductsList[index]['id']] == 0 || productQuantities[allproductsList[index]['id']] == null
                                          ? InkWell(
                                        onTap: () {
                                          setState(() {
                                            productQuantities[allproductsList[index]['id']] =
                                                (productQuantities[allproductsList[index]['id']] ?? 0) + 1;
                                        ...
                                        children: [
                                          InkWell(
                                            onTap: () {
                                              setState(() {
                                                if (productQuantities[allproductsList[index]['id']] != null && productQuantities[allproductsList[index]['id']]! > 0) {
                                                  productQuantities[allproductsList[index]['id']] = productQuantities[allproductsList[index]['id']]! - 1;
                                                  if (productQuantities[allproductsList[index]['id']] == 0) {
                                                ...
                                                try {
                                                  existingItem = cartProvider.cartItems.firstWhere((item) => item.name == allproductsList[index]['name'],
                                                      );
                                                } catch (e) {
                                                  existingItem = null;
                                                }
                                    ...
                                    // Show a SnackBar to notify the user about the quantity increment
                                                  ...
                                                  var item = CartItem(
                                                    id: allproductsList[index]['id'] as int,
                                                    image: allproductsList[index]['image'] ?? 'default_image_path',
                                                    name: allproductsList[index]['name'] ?? 'Unknown Product',
                                                    sell_price: double.parse('${allproductsList[index]['sell_price'].replaceAll(',', '')}'),
                                                    after_discount_price: double.parse('${allproductsList[index]['after_discount_price'].replaceAll(',', '')}'),
                                                ...
                                                updateProductQuantityInMap(
                                                    ...
                                                    productQuantities[allproductsList[index]['id']] ?? 0);
                                              });
                                            },
                                            child: Container(
                          ...
                          Positioned(
                            ...
                            child: GestureDetector(
                              onTap: () async {
                                ...
                                favoriteProvider.toggleFavorite(allproductsList[index]['id']);
                                // Perform the appropriate action based on the updated status
                                if (favoriteProvider.isFavorite(allproductsList[index]['id'])) {
...
// Retrieve the wishlist ID from _wishlistItems
                                  for (var item in _wishlistItems) {
                                    ...
                                    if (wishlistProductId == allproductsList[index]['id']) {
                                      wishlistId = item['id'];
                                      break;
                                    }
                                  }
...
// Pass the retrieved wishlist ID to removeFromWishlist
                              ...
                              child: Icon(
                                ...
                                favoriteProvider.isFavorite(allproductsList[index]['id'])
                                    ? Icons.favorite
