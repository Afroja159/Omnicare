...
class _OtherProductsSectionState extends State<OtherProductsSection> {
  ...
  Widget build(BuildContext context) {
    ...
    showOtherProducts ? otherproductList : otherproductList.take(6).toList();
        ...
        child: GridView.builder(
          ...
          itemBuilder: (context, index) {
            return Stack(
              children: [InkWell(
                onTap: () {
                  Get.to(ProductDetailsScreen(productDetails: otherproductList[index],));
                },
                child: Container(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    if (otherproductList[index]['discount_type']?.toLowerCase() == 'percent')
                                      Text(
                                        '% Off',
                ...
                Positioned(
                  ...
                  child: GestureDetector(
                    onTap: () async {
                      ...
                      favoriteProvider.toggleFavorite(otherproductList[index]['id']);
                      // Perform the appropriate action based on the updated status
                      if (favoriteProvider.isFavorite(otherproductList[index]['id'])) {
...
// Retrieve the wishlist ID from _wishlistItems
                        for (var item in _wishlistItems) {
                          ...
                          if (wishlistProductId == otherproductList[index]['id']) {
                            wishlistId = item['id'];
                            break;
                          }
                        }
