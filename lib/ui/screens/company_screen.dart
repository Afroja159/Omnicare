...
class _CompanyScreenState extends State<CompanyScreen> {
  ...
  Future<void> fetchData() async {
    try {
      ...
      final response =
      await http.get(Uri.parse('https://app.omnicare.com.bd/api/all_brands'));
                  ...
                  itemBuilder: (context, index) {
                    return InkWell(
                      ...
                      child: ListTile(
                        ...
                        title: Text(filteredCompanyList[index]['brand_name'] ?? ''),
                        subtitle:
                        Text('${filteredCompanyList[index]['products_count'] ?? ''} items'),
