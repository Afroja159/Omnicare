                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      "All Product Price:",
                                      style: fontStyle(12.sp, const Color(0xff959090), FontWeight.w400),
                                    ),
                                    Text(
                                      "৳ $totalSellPrice",
                                      style: fontStyle(12.sp, Colors.black, FontWeight.w500),
                                    ),
                                  ],
                                ),
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style: fontStyle(12.sp, Colors.green, FontWeight.w500),
                                    ),
                                  ],
                                ),
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      "Total:",
                                      style: fontStyle(12.sp, ColorPalette.primaryColor, FontWeight.w400),
                                    ),
                                    Text(
                                      // "৳ $totalAfterDiscountPrice",
                                      "৳ ${cartProvider.getTotalAfterDiscountPrice()}",
                                      style: fontStyle(12.sp, ColorPalette.primaryColor, FontWeight.w500),
                                    ),
                                  ],
                                ),
                                SizedBox(
                                ...
                                MaterialButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    Get.to(
                                      PaymentMethodScreen(
                                        cartItems: cartItems,
                                        totalPrice: totalAfterDiscountPrice,
                                      ),
                                    );
                                  },
                                  child: Text(
