...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
      ...
      body:  RefreshIndicator(
        ...
        child: Padding(
          ...
          child: orderDetails != null
              ? _buildOrderDetails()
              : const ShimmerWidget(), // Show loading indicator if orderDetails is null
        ),
      ),
    );
  }
  ...
  Widget _buildOrderItem(Map<String, dynamic> item) {
    ...
    double price = double.parse(item['product']['after_discount_price'].replaceAll(RegExp(r'[^0-9.]'), ''));
...
// Calculate subtotal
  ...
  Widget _buildTimeline() {
    ...
    bool pendingActive = orderDetails['order']['order_status'].toLowerCase() == 'pending';
    bool confirmActive = orderDetails['order']['order_status'].toLowerCase() == 'confirmed';
    bool onTheWayActive = orderDetails['order']['order_status'].toLowerCase() == 'on_the_way';
    bool deliveredActive = orderDetails['order']['order_status'].toLowerCase() == 'delivered';
    bool denyActive = orderDetails['order']['order_status'].toLowerCase() == 'denied';
    return Column(
      children: [
        Padding(
          ...
          child: Row(
            children: [
              _buildCircleIndicator(0, active: pendingActive || confirmActive || onTheWayActive || deliveredActive || denyActive),
              _buildLine(0, active: confirmActive || onTheWayActive || deliveredActive || denyActive),
              _buildCircleIndicator(1, active: confirmActive || onTheWayActive || deliveredActive || denyActive),
              _buildLine(1, active: onTheWayActive || deliveredActive || denyActive),
              _buildCircleIndicator(2, active: onTheWayActive || deliveredActive || denyActive),
